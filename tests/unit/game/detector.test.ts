...
describe('computeDetectorReading', () => {
  ...
  it('stops reading a buried source once it has been dug up', () => {
    const dug = baseState({
      ...
      mapStates: { room1: { dug: { '4,1': true }, takenItems: {}, openedDoors: {}, toggledSwitches: {}, movedBlocks: {}, disarmedTraps: {} } },
    });
  ...
  it('stops reading a trap once it has been disarmed', () => {
    const state = baseState({
      ...
      mapStates: { room1: { dug: {}, takenItems: {}, openedDoors: {}, toggledSwitches: {}, movedBlocks: {}, disarmedTraps: { trap1: true } } },
    });
    const reading = computeDetectorReading(CTX.maps.room1!, state);
